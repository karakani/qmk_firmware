...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_PGUP,       KC_HOME,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_ESC,  KC_LGUI, EISU,             KC_LALT, KC_SPC , KC_PGDN,       KC_END ,KC_ENT , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N,    KC_BSPC, KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_ESC,  KC_LGUI, KC_LALT,          EISU,    KC_SPC , KC_PGDN,       KC_END ,KC_ENT , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
